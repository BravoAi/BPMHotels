<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("clean");
					i++;
					myInputs[i] = document.getElementById("newDescription");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid clean");
							myInputs[j].focus();
							return false;
						}
					j++;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid newDescription");
							myInputs[j].focus();
							return false;
						}
					j++;
...
<div id="container">
	<div id="header">
		New Process Instance: /HotelManagement/src/main/resources/com/bravo/management.jobOrder
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<label for="name">clean</label>
                            		<div class="div_checkbox">
                              		<input name="clean" type="checkbox" class="checkbox" id="clean" value="true" />
                            		</div>
              	
                            		<label for="name">newDescription</label>
                            		<div class="div_texbox">
                              		<input name="newDescription" type="text" class="textbox" id="newDescription" value="" />
                            		</div>
