<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("assignedToIO");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid assignedToIO");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: onCallP2.selectOncall
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">assignedToIO</label>
                            		<div class="div_texbox">
                              		<input name="assignedToIO" type="text" class="textbox" id="assignedToIO" value="${assignedToIO}" />
                            		</div>
