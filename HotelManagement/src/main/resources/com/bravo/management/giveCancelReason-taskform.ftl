<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("cancelReasonIO");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid cancelReasonIO");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: onCallP1.giveCancelReason
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">cancelReasonIO</label>
                            		<div class="div_texbox">
                              		<input name="cancelReasonIO" type="text" class="textbox" id="cancelReasonIO" value="${cancelReasonIO}" />
                            		</div>
